<script lang="ts">
  ...
  // A single global threshold scoped to the current search, not recomputed per page — it's
  // expected for a whole page to land on one side of it.
  $: medianClones = dashboard?.total_clone_statistics?.median ?? null;
